      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-32">
          ...
          <div className="md:col-span-5">
            ...
            <form action="https://formspree.io/f/replace-with-your-form-id" method="POST" className="space-y-6">
              <div>
                <input 
                  type="text" 
                  name="name" 
                  ...
                  required 
                  className="w-full bg-transparent border-b border-gray-700 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-gold transition-colors font-light"
                />
              </div>
              <div>
                <input 
              ...
              <div>
                <textarea 
                  ...
                  required 
                  rows={3}
                  className="w-full bg-transparent border-b border-gray-700 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-gold transition-colors font-light resize-none"
                />
              </div>
              <button type="submit" className="bg-accent text-white px-8 py-4 uppercase tracking-[0.2em] text-xs font-medium hover:bg-accent-dark transition-colors w-full sm:w-auto">
                Initiate Contact
              </button>
            </form>
          </div>
